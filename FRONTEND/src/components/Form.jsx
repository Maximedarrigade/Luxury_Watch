...
const Form = ({inputs, onSubmit, submitLabel}) => {
    ...
    return (
        ...
        <form className="text-center mt-5" onSubmit={handleSubmit(onSubmit)} style={{border: "1px solid #DCDBD4", borderRadius: "8px", padding: "30px", maxWidth: "400px", margin: "0 auto"}}>
            ...
            <button className="text-center mt-5" type='submit'>{submitLabel}</button>
